...
public class HDFCBank {
	...
	public int WithdrawAmount(int accountNumber, int amount) throws InsufficientAccountBalanceException, InvalidAccountNumberException {
	...
	public int FundTransfer(int withAcc, int depAcc, int amount)
